...
import kotlinx.android.synthetic.main.item_list_add_team.view.*
import java.util.*
import kotlin.collections.ArrayList

class AdapterListAddTeam(val context: Context, val data: MutableList<UserDto>
) :
        RecyclerView.Adapter<AdapterListAddTeam.ViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var v: View =
                LayoutInflater.from(parent.context).inflate(R.layout.item_list_add_team, parent, false)
    ...
    interface OnListenerdata {
        fun onClickData(data: UserDto)
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val datas = dataFilterList[position]
        holder.bindView(datas)
    ...
    fun removeAt(position: Int) {
        ...
        dataFilterList.removeAt(position)
