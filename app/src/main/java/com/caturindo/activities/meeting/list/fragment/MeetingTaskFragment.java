...
import com.caturindo.fragments.meeting.MeetingCurrentFragment;
import com.caturindo.fragments.meeting.MeetingPastFragment;
import com.caturindo.preference.Prefuser;
import com.google.android.material.floatingactionbutton.FloatingActionButton;
import com.google.android.material.tabs.TabLayout;

public class MeetingTaskFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        viewPagerAdapter.addFragment(new MeetingCurrentTaskFragment(), "Current");
        viewPagerAdapter.addFragment(new MeetingPastTaskFragment(), "Past");
