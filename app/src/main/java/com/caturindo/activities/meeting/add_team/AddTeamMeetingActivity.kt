...
import com.caturindo.activities.task.add_team.AdapterAddTeamTask
...
class AddTeamMeetingActivity : BaseActivity(), AddTeamMeetingContract.View, AdapterAddTeamTask.OnListener {
    val datas : ArrayList<AddMemberMeetingDto> = ArrayList()
    ...
    private var presenter: AddTeamMeetingPresenter = AddTeamMeetingPresenter(this)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_add_team_tasl)

        presenter = AddTeamMeetingPresenter(this)
        presenter.getUser()
        setupNavigationMenu()
        setupToolbar()
    ...
    override fun suksesAddMember(msg: String, data: AddMemberMeetingDto) {
    ...
    override fun onClick(data: UserDto) {
        presenter.addTeam(data.username.toString(), intent.getStringExtra("ID"))
    }
}